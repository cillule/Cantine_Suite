<div class="row">
    ...
    <div class="panel panel-primary text-center">
        ...
        <form role="form" method="post" action="<?php echo base_url("gestionnaire_control/generer_tableau_suivi") ?>">
            <fieldset>
    ...
    <div class="panel panel-primary text-center">
        ...
        <form role="form" method="post" action="<?php echo base_url("gestionnaire_control/generer_feuille_presence") ?>">
            <fieldset>
                <div class="panel-body">
