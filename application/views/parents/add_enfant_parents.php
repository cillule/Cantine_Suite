    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-primary">
            <div class="panel-heading text-center">
                    <div class="panel-title">Ajout d'enfant <i class="fa fa-plus"></i></div>
                </div>
            ...
            <form  role="form" method="post" action="<?php echo base_url("parents_control/sauvegarder_enfant"); ?>">
                <fieldset>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="InputNom" name="nom" placeholder="Entrer le nom de l'enfant" required>
                    </div>
                    <div class="form-group">
                        <label for="InputPrenom">Prenom</label>
                        <input type="text" class="form-control" id="InputPrenom" name="prenom" placeholder="Entrer le prenom de l'enfant" required>
                    </div>
                    <div class="form-group">
                        <label for="select_classe">Classe</label>
                        <select id="select_classe" name="select_classe" class="selectpicker form-control" data-style="btn-warning" required>
